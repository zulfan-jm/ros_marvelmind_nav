#include "ros/ros.h"
#include "ros_marvelmind_nav/hedge_imu_fusion.h"
#include "ros_marvelmind_nav/hedge_pos_ang.h"
...
public:
  ...
  void imu_fusion_callback(const ros_marvelmind_nav::hedge_imu_fusion::ConstPtr& imu_fusion_msg)
  {
    // Populate header
  ...
  void pos_ang_callback(const ros_marvelmind_nav::hedge_pos_ang::ConstPtr& pos_ang_msg)
  {
    // Populate header
